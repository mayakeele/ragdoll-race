...
public static class Vector2Extensions
{
    ...
    public static Vector3 ProjectHorizontal(this Vector2 inVector){
        // Projects the input Vector2 into 3D space onto the XZ plane
        return new Vector3(inVector.x, 0, inVector.y);
    }

    public static Vector3 ProjectHorizontalNormalized(this Vector2 inVector){
        // Projects the input vector onto the XZ plane
        return inVector.ProjectHorizontal().normalized;
    }
}
